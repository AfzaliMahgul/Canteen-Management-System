...
public class ItemListDrink extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_item_list_drink);
        ...
        mItemRef = FirebaseDatabase.getInstance().getReference().child("Drink");
