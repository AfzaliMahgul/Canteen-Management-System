...
public class DessertList extends AppCompatActivity {
    ...
    private final List<Item> dessertList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mItemRef = FirebaseDatabase.getInstance().getReference().child("Dessert");
        mAdapter = new DessertAdapter(dessertList);
        mRV = (RecyclerView) findViewById(R.id.dessert_rv);
